...
public class ActStatementElseImpl extends ASTWrapperPsiElement implements ActStatementElse {

  public ActStatementElseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ActVisitor visitor) {
    visitor.visitStatementElse(this);
  }
