...
public class ActExprConvertDotImpl extends ASTWrapperPsiElement implements ActExprConvertDot {

  public ActExprConvertDotImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ActVisitor visitor) {
    visitor.visitExprConvertDot(this);
  }
