...
public class ActPartImportImpl extends ASTWrapperPsiElement implements ActPartImport {

  public ActPartImportImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ActVisitor visitor) {
    visitor.visitPartImport(this);
  }
