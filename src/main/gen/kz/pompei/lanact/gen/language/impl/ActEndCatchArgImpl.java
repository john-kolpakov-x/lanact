...
public class ActEndCatchArgImpl extends ASTWrapperPsiElement implements ActEndCatchArg {

  public ActEndCatchArgImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ActVisitor visitor) {
    visitor.visitEndCatchArg(this);
  }
  ...
  public ActType getType() {
    return findNotNullChildByClass(ActType.class);
  }
