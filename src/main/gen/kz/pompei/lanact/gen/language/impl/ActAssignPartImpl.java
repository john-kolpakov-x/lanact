...
public class ActAssignPartImpl extends ASTWrapperPsiElement implements ActAssignPart {

  public ActAssignPartImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ActVisitor visitor) {
    visitor.visitAssignPart(this);
  }
