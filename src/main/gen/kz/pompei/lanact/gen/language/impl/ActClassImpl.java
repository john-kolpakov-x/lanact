...
public class ActClassImpl extends ASTWrapperPsiElement implements ActClass {

  public ActClassImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ActName_ getName_() {
    return findNotNullChildByClass(ActName_.class);
  }
